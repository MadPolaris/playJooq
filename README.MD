...
```
localhost:3rd-parties barry$ git clone https://github.com/sbtliquibase/sbt-liquibase-plugin.git
...
[2]. change directory into this project directory, execute sbt to start sbt console
